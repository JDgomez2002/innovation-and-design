...
% --------------------------------------------------------------------------------
% Nombre completo
\def \nombreestudiante {José Daniel Gómez Cabrera}
% Carné
\def \uvgcarne {21429}
% Facultad
...
% --------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Desarrollo de un sistema inteligente para la orientación vocacional de estudiantes graduandos con aspiración a estudiar una licenciatura}
% Mes de entrega
\def \mesentrega {Mayo }
% Año de entrega
\def \anoentrega {2025}
% Asesor
\def \nombreasesor {Ing. Ludwing Cano}

% Datos del tribunal examinador:
% --------------------------------------------------------------------------------
% Nombre del primer examinador
\def \nombreprimerex {Desconocido}
% Nombre del segundo examinador
\def \nombresegundoex {Desconocido}
% Fecha de aprobación
\def \fechaaprobacion {n de diciembre de 2025}
